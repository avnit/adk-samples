...
def return_instructions_root() -> str:
    instruction_prompt_v2 = """
            You are getting case information from wiz and use this information to manage the security context. Get the resolutions from the wiz api and apply simillar context to all the answers. 
            Ensure previous solved cases are used to solve furture cases. 
    """
